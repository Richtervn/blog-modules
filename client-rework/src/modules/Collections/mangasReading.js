...
export const addManga = form =>
  actionCreator(ADD_MANGA_START, ADD_MANGA_SUCCESS, ADD_MANGA_FAIL, mangasReading.add, form)();
...
export const quickUpdate = url =>
  actionCreator(QUICK_UPDATE_START, QUICK_UPDATE_SUCCESS, QUICK_UPDATE_FAIL, mangasReading.quickUpdate, url)();
...
export const getMangas = actionCreator(GET_MANGAS_START, GET_MANGAS_SUCCESS, GET_MANGAS_FAIL, mangasReading.getMangas);
