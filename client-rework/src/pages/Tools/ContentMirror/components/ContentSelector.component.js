...
class ContentSelector extends Component {
  ...
  handleChange(e) {
    ...
    const { collectionValue, onGetDocuments, history, onChangeCollectionValue, onChangeDocumentValue } = this.props;
    if (name === 'collection') {
  ...
  componentWillReceiveProps(nextProps) {
    const { record, onChangeDocumentValue, history } = this.props;
