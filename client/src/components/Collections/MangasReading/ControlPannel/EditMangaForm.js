...
export default class EditMangaForm extends React.Component {
  constructor(props) {
    super(props);
  ...
  getDefaultState(mangaProp) {
    const { Aka, Genre, Authors } = mangaProp;
    return { ...mangaProp, Aka: Aka.slice(0), Genre: Genre.slice(0), Authors: Authors.slice(0) };
  }
  ...
  handleChange(event, index) {
    ...
    switch (name) {
      case 'file':
        ...
        break;
      case 'Aka':
        this.state.Aka[index] = value;
        break;
      case 'Genre':
        this.state.Genre[index] = value;
        break;
      case 'Authors':
        this.state.Authors[index] = value;
        break;
      default:
  ...
  handleClear() {
    this.setState(this.getDefaultState(this.props.manga));
  }
