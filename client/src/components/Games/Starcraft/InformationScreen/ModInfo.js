    ...
    <div>
      <div className="sc-map-info-container text-center">
        ...
        <div className="sc-map-info-feature">
          <button className="sc-map-feature-btn" data-toggle="modal" data-target="#editStarcraftModModal">
            <i className="fa fa-pencil" />
          </button>
          <button className="sc-map-feature-btn" data-toggle="modal" data-target="#deleteStarcraftModModal">
            <i className="fa fa-times" />
          </button>
        </div>
        <div className="larger-star-rating">
          <StarRating name={mod.Name} value={parseInt(mod.Rating)} editing={false} />
        </div>
        <div
