...
class BasicSideBar extends Component {
  ...
  render() {
    ...
    const { children, onClickAdd, sortOptions, customClass } = this.props;
    return (
      <div className={classNames('basic-side-bar', customClass)}>
        <div className="tools-bar">
          <div className="feature-btns">
            ...
            <button
              className={classNames('btn', { active: activeTools === 'Search' })}
              onClick={() => this.setState({ activeTools: 'Search' })}>
              <i className="fa fa-search" />
            </button>
            <button
              className={classNames('btn', { active: activeTools === 'Sort' })}
