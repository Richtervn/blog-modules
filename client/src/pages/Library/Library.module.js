...
export const addBookshelf = formBody => actionCreator(ADD_BOOKSHELF, services.addBookshelf, { payload: formBody })();
export const editBookshelf = formBody => actionCreator(EDIT_BOOKSHELF, services.editBookshelf, { payload: formBody })();
