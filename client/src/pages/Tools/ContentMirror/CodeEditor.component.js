...
class CodeEditor extends Component {
  constructor(props) {
    super(props);
    this.state = { firstLoad: false, waitingLoadDocument: false };
  }
  ...
  componentWillReceiveProps(nextProps) {
    ...
    //Change document
    if (this.state.firstLoad && this.props.documentValue !== nextProps.documentValue) {
      this.setState({ waitingLoadDocument: true });
    }

    if (this.state.waitingLoadDocument) {
      if (this.props.currentLanguage === 'HTML') {
        this.editor.codeMirror.setValue(nextProps.htmlSource);
      }
      if (this.props.currentLanguage === 'CSS') {
        this.editor.codeMirror.setValue(nextProps.cssSource);
      }
      this.setState({ waitingLoadDocument: false });
    }
